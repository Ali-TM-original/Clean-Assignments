...
//Please write your neptun code here: 000000
//Name= Ali-TM-original
...
// Use abort as told by professor
...
isLeapYear :: Int -> Bool
isLeapYear y
| (y rem 100 == 0) && not (y rem 400 == 0) = False
| y rem 4 == 0 = True
= False
...
leapYear year = check
where
	// Technically correct but must find a better way
	check
  		| ( ( CompleteDivision year 100 ) == 0 ) && ( ( CompleteDivision year 400 ) == 0 ) = True
  		| ( ( ( CompleteDivision year 4 ) == 0 ) && ( ( CompleteDivision year 100 ) == 0 ) && ( ( CompleteDivision year 400 ) == 0 )) = True
  		| ( ( ( CompleteDivision year 4 ) == 0 ) && ( ( CompleteDivision year 100 ) == 0 ) && ( ( CompleteDivision year 400 ) > 0 )) = False
